...
18,469 edges total; 9,832 (53%) are cross-archive connections.
...
30 clusters with ≥ 2 words (smaller clusters omitted since silhouette requires at least 2 members).
...
- **Mean silhouette** is the average across all words in the cluster — the overall coherence. A high mean (like 0.69 for "taylor / woodrow / anglian") means most words in that cluster are much closer to each other than to any other cluster's words.
